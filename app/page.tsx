    ...
    <main className="bg-[#090909] text-[#f5f1e8] overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-[#f5f1e8] text-[#171512] px-6 overflow-hidden">
        <motion.div
          ...
          className="absolute w-[500px] h-[500px] rounded-full border border-[#c9a96e]/10 pointer-events-none"
        />
        <motion.div
          animate={{
            scale: [1, 1.05, 1],
          ...
          className="absolute w-[250px] h-[250px] rounded-full bg-[#c9a96e]/5 blur-[100px]"
        />
        <motion.div
          initial={{
            opacity: 0,
        ...
        >
          <p className="text-sm tracking-[0.3em] text-[#9c7b42] mb-8">
            අපේ කතාව
          </p>
          ...
          <div className="w-16 h-px bg-[#c9a96e] mx-auto my-10" />
          <p className="text-base md:text-lg leading-8 text-black/60">
