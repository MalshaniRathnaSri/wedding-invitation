...
export default function RSVPSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#f5f1e8] px-6 py-24 text-[#171512] md:px-12">
      ...
      />
      <motion.div
        className="absolute -left-36 top-20 h-72 w-72 rounded-full border border-[#9b7a45]/15"
        animate={{ rotate: 360 }}
        transition={{
          duration: 40,
          repeat: Infinity,
      ...
      />
      <motion.div
        className="absolute -right-36 bottom-20 h-72 w-72 rounded-full border border-[#9b7a45]/15"
        animate={{ rotate: -360 }}
        transition={{
          duration: 45,
          repeat: Infinity,
