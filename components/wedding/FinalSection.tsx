...
export default function FinalSection() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#090909] px-6 py-24 text-[#f5f1e8] md:px-12">
      ...
      />
      <motion.div
        className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#c9a96e]/10"
        animate={{ rotate: 360 }}
        transition={{
          duration: 50,
          repeat: Infinity,
      ...
      />
      <motion.div
        className="absolute left-1/2 top-1/2 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#c9a96e]/10"
        animate={{ rotate: -360 }}
        transition={{
          duration: 35,
          repeat: Infinity,
