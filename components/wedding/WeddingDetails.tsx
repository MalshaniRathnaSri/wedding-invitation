...
export default function WeddingDetails() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#f5f1e8] px-6 py-24 text-[#171512] md:px-12">
      <motion.div
        className="absolute left-1/2 top-20 h-72 w-72 -translate-x-1/2 rounded-full bg-[#c9a96e]/10 blur-3xl"
        animate={{
          scale: [1, 1.15, 1],
          opacity: [0.5, 0.8, 0.5],
        }}
      ...
      />
      <motion.div
        className="absolute -right-32 top-20 h-72 w-72 rounded-full border border-[#c9a96e]/20"
        animate={{ rotate: 360 }}
        transition={{
          duration: 30,
          repeat: Infinity,
      ...
      />
      <motion.div
        className="absolute -left-32 bottom-20 h-64 w-64 rounded-full border border-[#c9a96e]/15"
        animate={{ rotate: -360 }}
        transition={{
          duration: 35,
          repeat: Infinity,
